...
class Auth:
    ...
    async def get_current_user(
        ...
        The get_current_user function is a dependency that will be used in the
            protected endpoints. It uses the OAuth2 authorization scheme to get and validate
            an access token. If validation is successful, it gets the user data from cache or database.
